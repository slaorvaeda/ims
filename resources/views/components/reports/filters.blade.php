...
<div class="p-6 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 rounded-[2rem] shadow-sm">
    <h3 class="font-heading font-bold text-base text-slate-800 dark:text-white mb-4 flex items-center gap-2">
        <svg class="w-5 h-5 text-[#FF5A36]" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 border-t border-slate-100 dark:border-slate-800/80 pt-4">
            ...
            <div class="flex flex-wrap items-center gap-1.5">
                ...
                <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                    ...
                    <span class="text-xs font-semibold text-slate-600 dark:text-slate-400 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800/80 px-3.5 py-1.5 rounded-xl peer-checked:bg-[#FF5A36] peer-checked:text-white peer-checked:border-[#FF5A36] hover:bg-slate-50 dark:hover:bg-slate-900/50 transition-all">All Portals</span>
                </label>
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                <div class="relative w-full sm:w-64">
                    <input type="text" name="search" value="{{ $search }}" placeholder="Search Serial, SKU, Name..." class="w-full pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-slate-950 border border-slate-200/60 dark:border-slate-800/80 rounded-2xl text-slate-800 dark:text-slate-200 text-xs focus:outline-none focus:border-[#FF5A36] focus:ring-2 focus:ring-[#FF5A36]/15 transition-all">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="px-5 py-2.5 bg-[#FF5A36] hover:bg-[#e04826] text-white font-semibold rounded-2xl text-xs transition-all shadow-md shadow-orange-900/10">Apply Filters</button>
